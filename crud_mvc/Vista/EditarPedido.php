...
$Pedido=$Controlador->BuscarPedido($_GET["Id"]);
...
<body onload="listarDetallesPedido()">
    ...
    <div class="card-bordy">
        ...
        <label>Pedido:</label>
        <input type="text" name="idPedido" id="idPedido" class="form-control" readonly value="<?php echo $Pedido->getIdPedido();?>"/>
        ...
        <label>Cliente:</label>
            <select name="cliente" id="cliente" class="form-control">
                ...
                foreach($ListaClientes as $C){
                    ...
                    <?php if($C->getNumeroDocumento() == $Pedido->getIdCliente()){ ?>
                    selected
                    <?php
                }
                ?>>
